<style>
  ...
  #add-new-user .offcanvas-body {
    overflow-y: auto;
  }
</style>

<div class="offcanvas offcanvas-end bg-white" id="add-new-user">
            ...
            <div class="offcanvas-body flex-grow-1">
              <form class="add-new-user pt-0 row g-3" method="post" name="form-add-new-user" id="form-add-new-user" onsubmit="return false">
                ...
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="poa_bus3_description" id="poa_bus3_description"
                      class="form-control"
                      value="Civil Penalties,Section 4980H">
                  </div>
                  <div class="col-md-4 mb-3">
                ...
                <div class="col-sm-12">
                  <button type="submit" id="btn-save" data-form="form-add-new-user" class="btn btn-primary data-submit me-sm-4 me-1">Submit</button>
