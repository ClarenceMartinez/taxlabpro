            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{route('calendar.index')}}" class="stretched-link">Calendar</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{route('welcome.index')}}" class="stretched-link">Dashboard</a>
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-4 me-xl-1">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end py-0" id="grap-notification">
                    <li class="dropdown-menu-header border-bottom py-50">
                      <div class="dropdown-header d-flex align-items-center py-2">
                        <h6 class="mb-0 me-auto">Notification</h6>
                        <div class="d-flex align-items-center">
                          <span class="badge rounded-pill bg-label-primary fs-xsmall me-2" id="countable-notification">8 New</span>
                          <a
                            href="javascript:void(0)"
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../../assets/img/avatars/{{Auth::user()->avatar}}.png" alt class="rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{route('users.profile', base64_encode(Auth::user()->id))}}">
