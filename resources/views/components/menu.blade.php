<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <a href="{{ route('clients.index')}}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <span style="color: var(--bs-primary)">
                  <img src="../../assets/img/pre-logo.png">
                </span>
              </span>
              <span class="app-brand-text demo menu-text fw-semibold ms-2"><img src="../../assets/img/logo.png" height="15"></span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboards -->
            <li class="menu-item {{ request()->is('welcome') ? 'active open' : '' }}">
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ request()->is('clients*') ? 'active open' : '' }}">
                  <a href="{{ route('clients.index') }}" class="menu-link">
                    <div data-i18n="All Clients">List</div>
                  </a>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ request()->is('users') ? 'active' : '' }}">
                  <a href="{{ route('users.index') }}" class="menu-link">
                    <div data-i18n="All Users">List</div>
                  </a>
                </li>
            ...
            <li class="menu-item {{ request()->is('company') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ri-building-2-fill"></i>
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ request()->is('company') ? 'active' : '' }}">
                  <a href="{{ route('company.index') }}" class="menu-link">
                    <div data-i18n="All Company">List</div>
                  </a>
                </li>
