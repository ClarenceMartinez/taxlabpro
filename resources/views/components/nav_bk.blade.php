<nav style="border-bottom: 2px solid white;" class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-6">
              <a href="/" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo menu-text fw-semibold">TaxLabPro</span>
              </a>
