<div class="offcanvas offcanvas-end w-50" id="edit-client">
            ...
            <div class="offcanvas-body flex-grow-1">
              <form class="edit-client pt-0 row g-3" id="form-edit-client" onsubmit="return false">
                ...
                <div class="col-12 col-md-2">
                  <div class="form-floating form-floating-outline">
                    <input
                      ...
                      class="form-control modal-edit-tax-id"
                      placeholder="123 456 7890" />
                    <label for="zipocode">ZipCode</label>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-4">
                      ...
                      <div class="col-8">
                          <div class="col mt-2">
                              <div class="form-check form-check-inline">
                                <input name="marital_status" class="form-check-input" type="radio" value="1" id="marital_status-married" checked="">
                                <label class="form-check-label" for="marital_status-married">Married</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input name="marital_status" class="form-check-input" type="radio" value="2" id="marital_status-unmarried">
