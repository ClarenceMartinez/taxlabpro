...
$(function () {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<li><a href="abc" class="dropdown-item profile-item-user" data-bs-toggle="modal" data-bs-target="#profileUser" data-idx="'+full.id+'" >Profile</a></li>' +
              ...
              '</ul>' +
              '</div>' +
              '<a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit edit-client"><i class="ri-edit-box-line"></i></a>'
            );
          }
        }
      ],
  ...
  $('.datatables-basic tbody').on('click', '.edit-client', function () {
    ...
    const editClient = document.querySelector('.edit-client'),
        offCanvasElement = document.querySelector('#edit-client');
...
jQuery(document).on('click', '.profile-item-user',function(e)
{
  ...
  $(".btn-asigment").attr('data-client', _idx);
})
...
jQuery(document).on('click', '#form-add-new-record #btn-save',function(e)
{
  // console.log("hola");
      ...
      //     url: '/clients/save',
      //     type: 'post',
      //     data: $("#form-add-new-record").serialize(),
