...
(function () {
  ...
  if (dt_crm.length) {
    dt_crm = dt_crm.DataTable({
      ...
      dom: 't',
      columns: [{ data: 'id' }, { data: 'name' }, { data: 'email' }, { data: 'phone' },{ data: 'role' }, { data: 'status' }, {data:''}],
      columnDefs: [
        {
          targets: 0,
          searchable: false,
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<li><a href="javascript:;" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#profileUser">Client Center</a></li>' +
