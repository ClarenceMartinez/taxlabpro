...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var baseUri = $('meta[name="base-url"]').attr('content');
      // Search API AJAX call
      var searchData = $.ajax({
        // url: assetsPath + 'json/' + searchJson, //? Use your own search api instead
        url: baseUri + '/clients/list/', //? Use your own search api instead
        dataType: 'json',
        async: false
      }).responseJSON;
        ...
        searchInput
          .typeahead(
            ...
            // Pages
            {
              ...
              display: 'name',
              limit: 5,
              source: filterConfig(searchData.list),
              templates: {
          ...
          .bind('typeahead:select', function (ev, suggestion) {
            ...
            // }
              ...
              // Evita cualquier acción por defecto adicional (opcional)
              ev.preventDefault();
          })
          // On typeahead close
